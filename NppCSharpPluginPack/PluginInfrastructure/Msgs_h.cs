...
namespace Kbg.NppPluginNET.PluginInfrastructure
{
    ...
    public enum NppMsg : uint
    {
        ...
        ///<summary>
        /// To notify plugins of the user's native language preference.<br></br>
        /// This is emitted when Notepad++ starts up (after translations have been loaded from nativeLang.xml)<br></br>
        /// and whenever the user changes their native language preference.<br></br>
        /// This notification was first implemented in Notepad++ v8.7.0.<br></br>
        /// <code>
        /// scnNotification->nmhdr.code = NPPN_RELOADNATIVELANG;<br></br>
        /// scnNotification->nmhdr.hwndFrom = hPluginMenu; // the menu handle to the plugin menu, so that plugins can find their plugin's submenu and re-translate their menu items<br></br>
        /// scnNotification->nmhdr.idFrom = languageName; // the ANSI encoded English name of the current UI language for Notepad++ (this is the same as the name of the localization XML file)
        /// </code>
        ///</summary>
        NPPN_RELOADNATIVELANG = NPPN_FIRST + 31,
